...
std::tuple<uint64_t, double, double> post_process_photons(const double next_dt, Census_T &all_photons, size_t batch_start, size_t batch_end, const Mesh &mesh, std::vector<std::vector<Photon>> &send_list);

template <>
std::tuple<uint64_t, double, double> post_process_photons<std::vector<Photon>>(const double next_dt, std::vector<Photon> &all_photons, size_t batch_start, size_t batch_end, const Mesh &mesh, std::vector<std::vector<Photon>> &send_list) {
...
template <>
std::tuple<uint64_t, double, double>  post_process_photons<PhotonArray>(const double next_dt, PhotonArray &all_photons, size_t batch_start, size_t batch_end,  const Mesh &mesh, std::vector<std::vector<Photon>> &send_list) {
